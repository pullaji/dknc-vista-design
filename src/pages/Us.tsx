  ...
  const teamMembers = [
    {
      ...
      yearsExperience: 11,
      achievements: ['Named among IGEN\'s top 50 under 40', 'Two-time recipient of IIID awards', 'Awarded two gold medals for academic excellence', 'Founded DKNC Studio in 2018', 'Successfully executed diverse range of projects', 'Volunteered for NGO school rebuilding in Nepal', 'Member of Council of Architects (COA), New Delhi', 'Member of Indian Institute of Architects (IIA), Hyderabad Chapter', 'Member of Indian Institute of Interior Designers (IIID), Hyderabad Chapter']
    },
    {
      id: 'chaitanya',
